...
-->
        <div class="nk-header-title nk-header-title-full nk-header-title-parallax-opacity">
            <div class="bg-image">
                <div style="background-image: url('assets/images/image-3.jpg');" class="op-4"></div>
            </div>
                        ...
                        <div class="nk-header-text">
                            ...
                            <div class="container">
                                <div class="text-xs-center">
                                    <h2 class="nk-title display-4">Project-Reborn</h2>
                                    ...
                                    <div class="row">
                                        <div class="col-md-8 offset-md-2">
                                            <p class="lead">You are not prepared!</p>

                                            <div class="nk-gap-2"></div>
                                            <div class="nk-countdown" data-end="2028-11-26 14:30" data-timezone="EST"></div>
                                        </div>
                                    </div>
                                </div>
                            </div>

...
<!--
Development by: Brian8544
Template Nulled by: Nex4iz
Registration: EmuDevs
-->
...
<head>
    ...
    <meta name="description" content="World of Warcraft Wrath of the Lich King private server project.">
	<meta name="keywords" content="World of Warcraft, World of Warcraft Wrath of the Lich King, WoW private server, Private server, wow 3.3.5 private server, openwow, wow 3.3.5, world of warcraft private server" />
    <meta name="author" content="Brian8544">
    <title>Project-Reborn | WoW WotLK (3.3.5) Private Server</title>
...
-->
        <div class="nk-header-title nk-header-title-lg nk-header-title-parallax-opacity">
            <div class="bg-image">
                <div style="background-image: url('assets/images/arthasdad.jpg');"></div>
            </div>
                ...
                <div class="nk-header-table-cell">
                    <div class="container">
                        ...
                        <div class="nk-header-text">
                            ...
                            <h1 class="nk-title display-3">Welcome to Project-Reborn!</h1>

                            <div class="nk-gap-2"></div>
                            <a href="/account/register" target="_blank" class="nk-btn nk-btn-lg nk-btn-color-main-1 link-effect-4">
                                <span>Create an Account</span>
                            </a>
                            &nbsp;&nbsp;&nbsp;&nbsp;
                            <a href="https://discord.gg/5GDExP3" class="nk-btn nk-btn-lg link-effect-4">
                ...
                <div class="col-md-4">
                    <div class="nk-ibox">
                        ...
                        <div class="nk-ibox-cont">
                            <h2 class="nk-ibox-title">Professionally Managed</h2>
                            Because all our staff is well trained, we provide the assistance players need.
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="nk-ibox">
                        ...
                        <div class="nk-ibox-cont">
                            <h2 class="nk-ibox-title">Quality Scripting</h2>
                            Scripts will only be published to our live servers when undergone testing.
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="nk-ibox">
                        ...
                        <div class="nk-ibox-cont">
                            <h2 class="nk-ibox-title">Community Input</h2>
                            Because this project wouldn't be possible without YOU, everyone can participate by creating suggestions on our forum.
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="nk-box bg-dark-1">
            <div class="container text-xs-center">
                <div class="nk-gap-6"></div>
                <div class="nk-gap-2"></div>
                <h2 class="nk-title h1">About Us</h2>
                <div class="nk-gap-3"></div>

                <p class="lead">Project-Reborn, started out as a small friendly World of Warcraft private server community. Currently we are expanding into other games aswell! The importance about our project, is that YOU can participate by creating suggestions on our forum.</p>
                ...
                <div class="row equal-height no-gap multi-columns-row">
                    <div class="col-md-4">
                        <div class="nk-box-2 nk-box-line">
                            ...
                            <!-- END: Counter 1: Total Created Accounts -->
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="nk-box-2 nk-box-line">
                            ...
                            <div class="nk-counter-3">
								...
								$stmt = $conn->prepare("SELECT name FROM characters WHERE online=?"); 
                    ...
                    <div class="col-md-4">
                        <div class="nk-box-2 nk-box-line">
                            <!-- START: Counter -->
                            <div class="nk-counter-3">
                              <div class="nk-count"> <!-- DATABASE CONFIG 3 -->
                                <?php
                                include 'config/database.php';
                                $query = mysql_query("SELECT * FROM stats WHERE `id` = 1");
                                while($output = mysql_fetch_assoc($query))
                                {
                                  echo '<p>'.$output['highestpoptotal'].'</p>';
                                }
                                ?>
                              </div>
                                <h3 class="nk-counter-title h4">Highest population online at the same time across all servers</h3>
                                <div class="nk-gap-1"></div>
                            </div>
                            <!-- END: Counter -->
                        </div>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-8 offset-md-2">
                    <div class="nk-plain-video" data-video="https://www.youtube.com/watch?v=ME0T5ZRRqO0"></div>
                </div>
            </div>
            <div class="nk-gap-2"></div>
            <div class="nk-gap-6"></div>
        ...
        <div class="nk-box bg-dark-1 text-xs-center">
            ...
            <div class="container">
                <h2 class="display-4">Launch Date - World of Warcraft Realm</h2>
                <div class="nk-gap"></div>
                <div>Enter Twilight!</div>
                <div class="nk-gap-4"></div>

                <div class="nk-countdown" data-end="2018-7-12 08:20" data-timezone="EST"></div>
            </div>
            <div class="nk-gap-2"></div>
            <div class="nk-gap-6"></div>
        </div>
...
-->
        <footer class="nk-footer nk-footer-parallax nk-footer-parallax-opacity">
            ...
            <div class="container">
                ...
                <p>
                    &copy; 2017 Project-Reborn, developed in association with Nexus Entertainment LLC. are the property of their respective owners. All Rights Reserved.
                </p>
...
-->
    <div class="nk-side-buttons nk-side-buttons-visible">
        <ul>
            <li>
                <a href="https://www.facebook.com/OfficialProjectReborn/" target="_blank" class="nk-btn nk-btn-lg link-effect-4">Like our Facebook page!</a>
            </li>
            <li>
